...
from app.api.routes.bi_atencion import router as bi_atencion_router
...
# BI Atencion: /api/v1/bi/atencion/* (tablero de atencion por gestion, F6 2026-09-19).
app.include_router(bi_atencion_router)

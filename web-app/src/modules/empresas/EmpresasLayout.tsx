...
export function EmpresasLayout({ children }: { children: ReactNode }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, maxWidth: 1400, margin: '0 auto', width: '100%', padding: '0 8px' }}>
      ...
      >
        ...
        <span style={{ color: 'var(--fg-2)', fontWeight: 600 }}>Empresa</span>
      </nav>

      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <Building2 size={32} strokeWidth={1.5} color="var(--zaris-orange)" />
        <div>
          <h1 style={{
          ...
          <p style={{ fontSize: '0.82rem', color: 'var(--fg-3)', margin: '2px 0 0' }}>
            Base Unica de Ciudadanos — razones sociales y actividad economica
          </p>
        </div>
      </div>

...
import {
  ...
  type GeoBuscarResult,
} from '../lib/geoNominatim'

interface Props {
  onPick: (normalizada: DireccionNormalizada, raw: GeoBuscarResult) => void
  placeholder?: string
  disabled?: boolean
}

export function AddressSearch({ onPick, placeholder, disabled }: Props) {
  ...
  // Debounce 500ms. El backend ya hace rate-limit hacia Nominatim.
  useEffect(() => {

...
**Aplicada en local y prod al 2026-06-13** (commit `5d81080`). Recovery de credenciales para usuarios internos + DNI en agentes. (Bitácora detallada pendiente — registrada acá para mantener la numeración; el detalle vive en el commit.)

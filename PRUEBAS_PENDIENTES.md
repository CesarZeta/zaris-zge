...
- `lmartinez@municipio.gob.ar` / `[redactado]` → Laura Martínez (agente id=2, usuario id=7, nivel 3, no auditor).
- `mgonzalez@municipio.gob.ar` / `[redactado]` → María González (agente id=3, usuario id=8, nivel 3, auditor).
